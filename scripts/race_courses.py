...
RACES = [
    ...
    dict(
        ...
        city="Seattle, WA",
        venue="Seward Park · Lake Washington Blvd S",
        accent="#e6738f",
        glyph="rc-blossom",
    ...
    dict(
        ...
        city="Kirkland, WA",
        venue="Juanita Beach Park · 9703 NE Juanita Dr",
        accent="#4fb3a5",
        glyph="rc-anchor",
        course="kirkland_5k",
        note=[
    ...
    dict(
        ...
        surface="paved trail",
        city="Redmond, WA",
        venue="Downtown Park · 161st Ave NE",
        accent="#e0a53c",
        glyph="rc-mug",
    ...
    dict(
        ...
        city="Seattle, WA",
        venue="Lake Union Park · near MOHAI",
        accent="#7a6fd6",
        glyph="rc-gasworks",
    ...
    dict(
        ...
        city="Seattle, WA",
        venue="Seward Park · 5900 Lake Washington Blvd S",
        accent="#e08344",
        glyph="rc-pumpkin",
        course="pumpkin_1mi",
        note=[
    ...
    dict(
        ...
        city="Seattle, WA",
        venue="Seattle Center · Mercer St",
        accent="#a5714f",
        glyph="rc-cocoa",
    ...
    dict(
        ...
        city="Boston, MA",
        venue="Charles St · Boston Common",
        accent="#f0c23c",
        glyph="rc-unicorn",
        course=None,
        route=dict(
