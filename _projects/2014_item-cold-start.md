...
**More details: [paper]({{ "/assets/invited-talks/2014_item_cold_start/paper.pdf" | prepend: site.baseurl }}), [slides]({{"/assets/invited-talks/2014_item_cold_start/slides.pdf" | prepend: site.baseurl}}).**
